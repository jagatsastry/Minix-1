...
_PROTOTYPE( int sys_exec, (int proc, char *ptr, char *aout, vir_bytes initpc)   );
...
#define sys_getbiosbuffer(virp, sizep)  sys_getinfo(GET_BIOSBUFFER, virp, sizeof(*virp), sizep, sizeof(*sizep))
