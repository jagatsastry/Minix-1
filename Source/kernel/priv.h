 ...
 */
/* Me:
 * The priv structure is not part of the process table, rather each process
 * table slot has a pointer to an instance of it.
 */
struct priv {
  ...
  /* Me:
   * For user process, the remaining fields are not relevant.
   * User processes have notifications, signals, and timers
   * managed on their behalf by the process manager.
   */
